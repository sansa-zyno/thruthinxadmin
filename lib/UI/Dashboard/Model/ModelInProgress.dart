...
class ModelsInProgress extends StatelessWidget {
  const ModelsInProgress({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance
          .collection("user")
          .where("verification", isEqualTo: "UNKNOWN")
          .snapshots(),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text("No Requests are In progress!",
